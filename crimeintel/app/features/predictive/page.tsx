...
import { ArrowLeft, BrainCircuit, LineChart, Target, AlertTriangle } from "lucide-react";
import { Button } from "@/components/ui/button";
import { PublicHeader } from "@/components/layout/PublicHeader";
import { FadeIn } from "@/components/ui/scroll-animation";

export default function PredictiveFeaturePage() {
  return (
          ...
          <FadeIn className="container px-4 md:px-6 relative z-10 mx-auto max-w-5xl">
            ...
            <div className="space-y-4">
              <div className="inline-flex items-center rounded-lg bg-primary/10 px-3 py-1 text-sm font-medium text-primary mb-2">
                <BrainCircuit className="mr-2 h-4 w-4" /> Feature Spotlight
              </div>
              <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
                Predictive AI Analytics
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mt-4 leading-relaxed">
                Anticipate criminal activity before it happens. Our advanced machine learning models analyze historical patterns to forecast crime spikes and recommend preemptive patrol routes.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm">
                ...
                <h3 className="text-xl font-bold mb-3">Trend Forecasting</h3>
                <p className="text-muted-foreground">
                  Use linear regression and time-series forecasting to predict incident volumes for the next 30, 60, and 90 days across any jurisdiction.
                </p>
              </div>
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Automatically flag critical deviations from historical baselines. Get instantly alerted when specific crime types suddenly surge in a district.
                </p>
              </div>
            </div>
