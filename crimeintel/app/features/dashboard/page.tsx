...
import { ArrowLeft, BarChart2, ShieldCheck, Map, Activity } from "lucide-react";
          ...
          <FadeIn className="container px-4 md:px-6 relative z-10 mx-auto max-w-5xl">
            ...
            <div className="space-y-4">
              <div className="inline-flex items-center rounded-lg bg-primary/10 px-3 py-1 text-sm font-medium text-primary mb-2">
                <BarChart2 className="mr-2 h-4 w-4" /> Feature Spotlight
              </div>
              <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
                Central Intelligence Dashboard
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mt-4 leading-relaxed">
                Real-time monitoring and analytics for police superintendents, inspectors, and intelligence officers. Make data-driven decisions instantly with live tactical overviews.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm">
                ...
                <h3 className="text-xl font-bold mb-3">Live Crime Heatmaps</h3>
                <p className="text-muted-foreground">
                  Visualize incident density and jurisdictional activity statistics in real-time. Identify hotspots and allocate resources proactively before situations escalate.
                </p>
              </div>
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm">
                ...
                <h3 className="text-xl font-bold mb-3">CCTNS Integration</h3>
                <p className="text-muted-foreground">
                  Seamless two-way integration with state CCTNS and Zoho databases. Data flows in securely without disrupting existing workflows.
                </p>
              </div>
            </div>
