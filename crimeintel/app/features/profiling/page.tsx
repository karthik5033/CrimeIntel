...
import { ArrowLeft, Users, Fingerprint, FileText, Database } from "lucide-react";
import { Button } from "@/components/ui/button";
import { PublicHeader } from "@/components/layout/PublicHeader";
import { FadeIn } from "@/components/ui/scroll-animation";

export default function ProfilingFeaturePage() {
  return (
          ...
          <FadeIn className="container px-4 md:px-6 relative z-10 mx-auto max-w-5xl">
            ...
            <div className="space-y-4">
              <div className="inline-flex items-center rounded-lg bg-primary/10 px-3 py-1 text-sm font-medium text-primary mb-2">
                <Users className="mr-2 h-4 w-4" /> Feature Spotlight
              </div>
              <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
                Suspect Profiling Database
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mt-4 leading-relaxed">
                A unified, 360-degree view of every known suspect. Cross-reference identities, aliases, and Modus Operandi (MO) instantly across over 1.2M+ records.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm">
                ...
                <h3 className="text-xl font-bold mb-3">Identity Resolution</h3>
                <p className="text-muted-foreground">
                  Our advanced entity resolution engine detects and merges duplicate suspect profiles, catching individuals attempting to use multiple aliases across different jurisdictions.
                </p>
              </div>
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm">
                ...
                <h3 className="text-xl font-bold mb-3">Automated Dossiers</h3>
                <p className="text-muted-foreground">
                  Generate comprehensive intelligence dossiers with a single click. Instantly compile criminal history, known associates, registered vehicles, and financial flags.
                </p>
              </div>
            </div>
